    ...
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm flex flex-col h-full">
      ...
      {projekte.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center gap-2 py-12 px-6 text-center min-h-[180px]">
          ...
          <Link href="/dashboard/projekte" className="mt-2 inline-flex items-center gap-1.5 px-3 py-1.5 bg-wellbeing-green hover:bg-wellbeing-green-dark text-white text-xs font-medium rounded-lg transition-colors">
            Projekt anlegen →
          </Link>
        </div>
      ) : (
