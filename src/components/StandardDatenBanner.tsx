...
/**
 * Banner auf der Kategorien-Seite, der Admins neuer Organisationen
 * ermöglicht, alle Standard-Daten (Kategorien, Vertragsvorlagen,
 * Onboarding-Vorlagen) auf einen Klick nachzuladen. Zeigt sich nur
 * wenn `istLeer` = true (sonst stört er etablierte Orgs nicht).
 */
